class DownshiftNetlifyPage
  ...
  in_iframe(id: 'storybook-preview-iframe') do |frame|
    ...
    span(:search_result_field_first, class: 'ais-Highlight__nonHighlighted', index: 0, frame: frame)
    mark(:search_result_field_second, class: 'ais-Highlight__highlighted', frame: frame)
    span(:search_result_field_third, class: 'ais-Highlight__nonHighlighted', index: 1, frame: frame)
  end
end
